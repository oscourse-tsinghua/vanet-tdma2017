...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "BCH_CANDIDATE_C3HOP_THRES_S1" -parent ${Page_0}
  ipgui::add_param $IPINST -name "BCH_CANDIDATE_C3HOP_THRES_S2" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "FRAME_SLOT_NUM" -parent ${Page_0}
  ipgui::add_param $IPINST -name "OCCUPIER_LIFE_FRAME" -parent ${Page_0}
  ipgui::add_param $IPINST -name "SLOT_US" -parent ${Page_0}
  ipgui::add_param $IPINST -name "TX_GUARD_US" -parent ${Page_0}
